...
export default function Notifications() {
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 && (
            <Badge
              variant="destructive"
              className="absolute top-0 right-0 h-3.5 w-3.5 rounded-full p-0 flex items-center justify-center text-[10px] font-medium border-2 border-background"
            >
              {unreadCount}
            </Badge>
          )}
      ...
      <PopoverContent className="w-72 p-0 mt-3" align="start">
